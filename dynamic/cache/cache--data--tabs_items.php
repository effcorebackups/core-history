...
namespace effcore { # cache for data--tabs_items
  ...
  cache::$data['data--tabs_items']['develop']['class_diagrams'] = new \effcore\tabs_item();
  cache::$data['data--tabs_items']['develop']['class_diagrams']->action_name = 'class/diagrams';
  cache::$data['data--tabs_items']['develop']['class_diagrams']->title = 'Diagrams';
  cache::$data['data--tabs_items']['develop']['class_diagrams']->id = 'class_diagrams';
  cache::$data['data--tabs_items']['develop']['class_diagrams']->id_parent = 'class';
  cache::$data['data--tabs_items']['develop']['class_diagrams']->attributes['class']['diagrams'] = 'diagrams';
