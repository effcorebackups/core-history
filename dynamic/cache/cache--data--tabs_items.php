...
namespace effcore { # cache for data--tabs_items
  ...
  cache::$data['data--tabs_items']['storage']['instance_select']->attributes['class']['select'] = 'select';
  ...
  cache::$data['data--tabs_items']['storage']['instance_insert']->attributes['class']['insert'] = 'insert';
  ...
  cache::$data['data--tabs_items']['storage']['instance_update']->attributes['class']['update'] = 'update';
  ...
  cache::$data['data--tabs_items']['storage']['instance_delete']->attributes['class']['delete'] = 'delete';
  ...
  cache::$data['data--tabs_items']['menu']['tree_select']->attributes['class']['select'] = 'select';
  ...
  cache::$data['data--tabs_items']['menu']['tree_insert']->attributes['class']['insert'] = 'insert';
