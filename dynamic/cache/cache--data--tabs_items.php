...
namespace effcore { # cache for data--tabs_items
  ...
  cache::$data['data--tabs_items']['core']['select']->action_name = 'select';
  ...
  cache::$data['data--tabs_items']['core']['insert']->action_name = 'insert';
  ...
  cache::$data['data--tabs_items']['core']['update']->action_name = 'update';
  ...
  cache::$data['data--tabs_items']['core']['delete']->action_name = 'delete';
