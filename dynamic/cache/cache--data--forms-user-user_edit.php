...
namespace effcore { # cache for data--forms-user-user_edit
  ...
  cache::$data['data--forms-user-user_edit']->children['credentials']->children['avatar']->fixed_name = 'avatar-%%_nick';
  ...
  cache::$data['data--forms-user-user_edit']->children['button_cancel'] = new \effcore\button();
  ...
  cache::$data['data--forms-user-user_edit']->children['button_cancel']->title = 'cancel';
