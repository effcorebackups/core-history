...
namespace effcore { # cache for data--pages-user-user
  ...
  cache::$data['data--pages-user-user']->content['block_menu_user']->handler = '\\effcore\\modules\\core\\events_page::on_show_block_menu_user';
  ...
  cache::$data['data--pages-user-user']->content['block_logo']->handler = '\\effcore\\modules\\core\\events_page::on_show_block_logo';
  cache::$data['data--pages-user-user']->content['block_title'] = new \stdClass();
  cache::$data['data--pages-user-user']->content['block_title']->region = 'content';
  cache::$data['data--pages-user-user']->content['block_title']->type = 'code';
  cache::$data['data--pages-user-user']->content['block_title']->handler = '\\effcore\\modules\\core\\events_page::on_show_block_title';
