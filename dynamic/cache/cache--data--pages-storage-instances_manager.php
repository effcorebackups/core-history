...
namespace effcore { # cache for data--pages-storage-instances_manager
  ...
  cache::$data['data--pages-storage-instances_manager']->content['users_insert']->display->check = 'page_args';
  cache::$data['data--pages-storage-instances_manager']->content['users_insert']->display->where = 'action';
  ...
  cache::$data['data--pages-storage-instances_manager']->content['users_select']->display->check = 'page_args';
  cache::$data['data--pages-storage-instances_manager']->content['users_select']->display->where = 'action';
  ...
  cache::$data['data--pages-storage-instances_manager']->content['users_update']->display->check = 'page_args';
  cache::$data['data--pages-storage-instances_manager']->content['users_update']->display->where = 'action';
  ...
  cache::$data['data--pages-storage-instances_manager']->content['users_delete']->display->check = 'page_args';
  cache::$data['data--pages-storage-instances_manager']->content['users_delete']->display->where = 'action';
