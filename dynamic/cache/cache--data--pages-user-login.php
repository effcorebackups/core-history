...
namespace effcore { # cache for data--pages-user-login
  ...
  cache::$data['data--pages-user-login']->content['block_logo']->handler = '\\effcore\\events_page::on_show_block_logo';
  cache::$data['data--pages-user-login']->content['block_title'] = new \stdClass();
  cache::$data['data--pages-user-login']->content['block_title']->region = 'content';
