...
namespace effectivecore { # cache for data--trees

  cache::$data['data--trees']['core']['main'] = new \effectivecore\tree();
  ...
  cache::$data['data--trees']['user']['user_anonymous'] = new \effectivecore\tree();
  ...
  cache::$data['data--trees']['user']['user_logged_in'] = new \effectivecore\tree();
