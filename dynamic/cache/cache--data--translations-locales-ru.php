...
namespace effcore { # cache for data--translations-locales-ru
  ...
  cache::$data['data--translations-locales-ru']->data['Access settings not applicable if no one role is not actived!'] = 'Настройки доступа не применяются, если ни одна роль не активна!';
  cache::$data['data--translations-locales-ru']->data['Access settings'] = 'Настройки доступа';
  ...
  cache::$data['data--translations-locales-ru']->data['Field can contain only the next characters: "a-z", "0-9", "-", "_".'] = 'Поле может содержать только следующие символы: "a-z", "0-9", "-", "_".';
  ...
  cache::$data['data--translations-locales-ru']->data['Menu for authenticated user'] = 'Меню для аутетифицированного пользователя';
  ...
  cache::$data['data--translations-locales-ru']->data['Menu'] = 'Меню';
  ...
  cache::$data['data--translations-locales-ru']->data['Module for storages support.'] = 'Модуль для поддержки хранилищ данных.';
  ...
  cache::$data['data--translations-locales-ru']->data['Module for working with pages.'] = 'Модуль для работы со страницами.';
  cache::$data['data--translations-locales-ru']->data['Module for working with user accounts and permissions.'] = 'Модуль для работы с пользовательскими аккаунтами и разрешениями.';
  ...
  cache::$data['data--translations-locales-ru']->data['Settings'] = 'Настройки';
