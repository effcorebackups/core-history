...
namespace effectivecore { # cache for settings--entities_instances
  ...
  cache_factory::$data['settings--entities_instances']['user']['user_1']->values['login'] = 'admin';
  ...
  cache_factory::$data['settings--entities_instances']['user']['user_2'] = new \effectivecore\instance();
  ...
  cache_factory::$data['settings--entities_instances']['user']['user_2']->values['login'] = 'user';
  ...
  cache_factory::$data['settings--entities_instances']['user']['role_anonymous'] = new \effectivecore\instance();
  ...
  cache_factory::$data['settings--entities_instances']['user']['role_registered'] = new \effectivecore\instance();
  ...
  cache_factory::$data['settings--entities_instances']['user']['role_admins'] = new \effectivecore\instance();
  ...
  cache_factory::$data['settings--entities_instances']['user']['role_moderators'] = new \effectivecore\instance();
  ...
  cache_factory::$data['settings--entities_instances']['user']['permission_user_profile_select'] = new \effectivecore\instance();
  ...
  cache_factory::$data['settings--entities_instances']['user']['permission_user_profile_update'] = new \effectivecore\instance();
  ...
  cache_factory::$data['settings--entities_instances']['user']['permission_user_profile_delete'] = new \effectivecore\instance();
  ...
  cache_factory::$data['settings--entities_instances']['user']['relation_role_ws_user_admins_1'] = new \effectivecore\instance();
  ...
  cache_factory::$data['settings--entities_instances']['user']['relation_role_ws_permission_admins_user_profile_select'] = new \effectivecore\instance();
  ...
  cache_factory::$data['settings--entities_instances']['user']['relation_role_ws_permission_admins_user_profile_update'] = new \effectivecore\instance();
  ...
  cache_factory::$data['settings--entities_instances']['user']['relation_role_ws_permission_admins_user_profile_insert'] = new \effectivecore\instance();
