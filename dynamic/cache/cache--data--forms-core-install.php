...
namespace effcore { # cache for data--forms-core-install
  ...
  cache::$data['data--forms-core-install']->children['storage']->title = 'Storage';
  ...
  cache::$data['data--forms-core-install']->children['storage']->children['mysql']->children['storage_login'] = new \effcore\field_text();
  cache::$data['data--forms-core-install']->children['storage']->children['mysql']->children['storage_login']->title = 'User name';
  cache::$data['data--forms-core-install']->children['storage']->children['mysql']->children['storage_login']->element_attributes['name'] = 'storage_login';
  cache::$data['data--forms-core-install']->children['storage']->children['mysql']->children['storage_login']->element_attributes['value'] = 'root';
  cache::$data['data--forms-core-install']->children['storage']->children['mysql']->children['storage_login']->element_attributes['minlength'] = 1;
  cache::$data['data--forms-core-install']->children['storage']->children['mysql']->children['storage_login']->element_attributes['maxlength'] = 64;
  cache::$data['data--forms-core-install']->children['storage']->children['mysql']->children['storage_login']->element_attributes['pattern'] = '%^[a-zA-Z0-9-_]+$%';
  cache::$data['data--forms-core-install']->children['storage']->children['mysql']->children['password'] = new \effcore\field_password();
  cache::$data['data--forms-core-install']->children['storage']->children['mysql']->children['password']->element_attributes['name'] = 'storage_password';
  ...
  cache::$data['data--forms-core-install']->children['user'] = new \effcore\fieldset();
  cache::$data['data--forms-core-install']->children['user']->title = 'User';
  cache::$data['data--forms-core-install']->children['user']->children['email'] = new \effcore\field_email();
  cache::$data['data--forms-core-install']->children['user']->children['email']->element_attributes['value'] = 'admin@example.com';
  cache::$data['data--forms-core-install']->children['user']->children['password'] = new \effcore\field_password();
