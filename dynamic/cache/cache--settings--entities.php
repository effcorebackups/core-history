...
namespace effectivecore { # cache for settings--entities
  ...
  cache_factory::$data['settings--entities']['page']['captcha']->fields->created = new \stdClass();
  cache_factory::$data['settings--entities']['page']['captcha']->fields->created->type = 'datetime';
  cache_factory::$data['settings--entities']['page']['captcha']->fields->created->not_null = true;
  ...
  cache_factory::$data['settings--entities']['user']['user']->fields->created->type = 'datetime';
