...
namespace effcore { # cache for data--storages
  ...
  cache::$data['data--storages']['storage']['storage_pdo_sql'] = new \effcore\different_cache();
  ...
  cache::$data['data--storages']['storage']['storage_files_nosql'] = new \effcore\different_cache();
