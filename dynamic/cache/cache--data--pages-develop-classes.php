...
namespace effcore { # cache for data--pages-develop-classes
  ...
  cache::$data['data--pages-develop-classes']->content['block_menu_user']->region = 'head_2';
  cache::$data['data--pages-develop-classes']->content['block_menu_user']->type = 'code';
  cache::$data['data--pages-develop-classes']->content['block_menu_user']->handler = '\\effcore\\modules\\core\\events_page::on_show_block_menu_user';
  cache::$data['data--pages-develop-classes']->content['block_logo'] = new \stdClass();
  cache::$data['data--pages-develop-classes']->content['block_logo']->region = 'head_3';
  cache::$data['data--pages-develop-classes']->content['block_logo']->type = 'code';
  cache::$data['data--pages-develop-classes']->content['block_logo']->handler = '\\effcore\\modules\\core\\events_page::on_show_block_logo';
  cache::$data['data--pages-develop-classes']->content['block_title'] = new \stdClass();
  cache::$data['data--pages-develop-classes']->content['block_title']->region = 'main_1';
  cache::$data['data--pages-develop-classes']->content['block_title']->type = 'code';
  cache::$data['data--pages-develop-classes']->content['block_title']->handler = '\\effcore\\modules\\core\\events_page::on_show_block_title';
  cache::$data['data--pages-develop-classes']->content['block_classes'] = new \stdClass();
  cache::$data['data--pages-develop-classes']->content['block_classes']->region = 'main_1';
