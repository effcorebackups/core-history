...
namespace effcore { # cache for data--pages-develop-classes
  ...
  cache::$data['data--pages-develop-classes']->content['block_logo']->type = 'link';
  cache::$data['data--pages-develop-classes']->content['block_logo']->dpath = 'blocks/page/logo';
  ...
  cache::$data['data--pages-develop-classes']->content['block_tabs'] = new \stdClass();
  cache::$data['data--pages-develop-classes']->content['block_tabs']->region = 'tabs';
  cache::$data['data--pages-develop-classes']->content['block_tabs']->type = 'link';
  cache::$data['data--pages-develop-classes']->content['block_tabs']->dpath = 'tabs/develop/classes';
  cache::$data['data--pages-develop-classes']->content['block_classes_list'] = new \stdClass();
  cache::$data['data--pages-develop-classes']->content['block_classes_list']->display = new \stdClass();
  cache::$data['data--pages-develop-classes']->content['block_classes_list']->display->check = 'action';
  cache::$data['data--pages-develop-classes']->content['block_classes_list']->display->where = 'page_args';
  cache::$data['data--pages-develop-classes']->content['block_classes_list']->display->match = '%list%';
  ...
  cache::$data['data--pages-develop-classes']->content['block_classes_diagrams']->display = new \stdClass();
  cache::$data['data--pages-develop-classes']->content['block_classes_diagrams']->display->check = 'action';
  cache::$data['data--pages-develop-classes']->content['block_classes_diagrams']->display->where = 'page_args';
  cache::$data['data--pages-develop-classes']->content['block_classes_diagrams']->display->match = '%diagrams%';
