...
namespace effcore { # cache for data--pages-core-install
  ...
  cache::$data['data--pages-core-install']->content['block_menu_user']->handler = '\\effcore\\events_page::on_show_block_menu_user';
  ...
  cache::$data['data--pages-core-install']->content['block_logo']->handler = '\\effcore\\events_page::on_show_block_logo';
