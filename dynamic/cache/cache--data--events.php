...
namespace effcore { # cache for data--events
  ...
  cache::$data['data--events']['develop']->on_form_init['demo'] = new \effcore\event();
  cache::$data['data--events']['develop']->on_form_init['demo']->for = 'demo';
  cache::$data['data--events']['develop']->on_form_init['demo']->handler = '\\effcore\\modules\\develop\\events_form::on_init_demo';
  cache::$data['data--events']['develop']->on_form_validate['demo'] = new \effcore\event();
  cache::$data['data--events']['develop']->on_form_validate['demo']->for = 'demo';
  cache::$data['data--events']['develop']->on_form_validate['demo']->handler = '\\effcore\\modules\\develop\\events_form::on_validate_demo';
  cache::$data['data--events']['develop']->on_form_submit['demo'] = new \effcore\event();
  cache::$data['data--events']['develop']->on_form_submit['demo']->for = 'demo';
  cache::$data['data--events']['develop']->on_form_submit['demo']->handler = '\\effcore\\modules\\develop\\events_form::on_submit_demo';
  ...
  cache::$data['data--events']['tree']->on_module_start['tree'] = new \effcore\event();
  cache::$data['data--events']['tree']->on_module_start['tree']->for = 'tree';
  cache::$data['data--events']['tree']->on_module_start['tree']->handler = '\\effcore\\modules\\tree\\events_module::on_start';
  cache::$data['data--events']['tree']->on_module_start['tree']->weight = -100;
  cache::$data['data--events']['tree']->on_module_install['tree'] = new \effcore\event();
  cache::$data['data--events']['tree']->on_module_install['tree']->for = 'tree';
  cache::$data['data--events']['tree']->on_module_install['tree']->handler = '\\effcore\\modules\\tree\\events_module::on_install';
