...
namespace effcore { # cache for data--pages-user-registration
  ...
  cache::$data['data--pages-user-registration']->content['block_menu_user']->handler = '\\effcore\\modules\\menu\\events_page::on_show_block_menu_user';
  ...
  cache::$data['data--pages-user-registration']->content['block_title']->handler = '\\effcore\\modules\\page\\events_page::on_show_block_title';
