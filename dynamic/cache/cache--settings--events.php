...
namespace effectivecore { # cache for settings--events
  ...
  cache_factory::$info['settings--events']['build'] = '2017-10-02 10:49:09';
  ...
  cache_factory::$data['settings--events']['develop']->on_form_validate['form_demo'] = new \stdClass();
  cache_factory::$data['settings--events']['develop']->on_form_validate['form_demo']->for = 'form_demo';
  cache_factory::$data['settings--events']['develop']->on_form_validate['form_demo']->handler = '\\effectivecore\\events_form::on_validate';
  cache_factory::$data['settings--events']['develop']->on_form_validate['form_demo']->weight = 0;
  ...
  cache_factory::$data['settings--events']['page']->on_form_validate['admin_decoration'] = new \stdClass();
  cache_factory::$data['settings--events']['page']->on_form_validate['admin_decoration']->for = 'admin_decoration';
  cache_factory::$data['settings--events']['page']->on_form_validate['admin_decoration']->handler = '\\effectivecore\\events_form::on_validate';
  cache_factory::$data['settings--events']['page']->on_form_validate['admin_decoration']->weight = 0;
  ...
  cache_factory::$data['settings--events']['user']->on_form_validate['user_login']->handler = '\\effectivecore\\events_form::on_validate';
  cache_factory::$data['settings--events']['user']->on_form_validate['user_login']->weight = 0;
  cache_factory::$data['settings--events']['user']->on_form_validate['user_logout'] = new \stdClass();
  cache_factory::$data['settings--events']['user']->on_form_validate['user_logout']->for = 'user_logout';
  cache_factory::$data['settings--events']['user']->on_form_validate['user_logout']->handler = '\\effectivecore\\events_form::on_validate';
  cache_factory::$data['settings--events']['user']->on_form_validate['user_logout']->weight = 0;
  cache_factory::$data['settings--events']['user']->on_form_validate['user_n_delete'] = new \stdClass();
  cache_factory::$data['settings--events']['user']->on_form_validate['user_n_delete']->for = 'user_n_delete';
  cache_factory::$data['settings--events']['user']->on_form_validate['user_n_delete']->handler = '\\effectivecore\\events_form::on_validate';
  cache_factory::$data['settings--events']['user']->on_form_validate['user_n_delete']->weight = 0;
  ...
  cache_factory::$data['settings--events']['user']->on_form_validate['user_n_edit']->handler = '\\effectivecore\\events_form::on_validate';
  cache_factory::$data['settings--events']['user']->on_form_validate['user_n_edit']->weight = 0;
  cache_factory::$data['settings--events']['user']->on_form_validate['user_registration'] = new \stdClass();
  cache_factory::$data['settings--events']['user']->on_form_validate['user_registration']->for = 'user_registration';
  cache_factory::$data['settings--events']['user']->on_form_validate['user_registration']->handler = '\\effectivecore\\events_form::on_validate';
  cache_factory::$data['settings--events']['user']->on_form_validate['user_registration']->weight = 0;
