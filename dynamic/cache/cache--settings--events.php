...
namespace effectivecore { # cache for settings--events
  ...
  cache_factory::$data['settings--events']['develop']->on_form_validate['demo_default'] = new \stdClass();
  cache_factory::$data['settings--events']['develop']->on_form_validate['demo_default']->for = 'demo';
  cache_factory::$data['settings--events']['develop']->on_form_validate['demo_default']->handler = '\\effectivecore\\events_form::on_validate';
  cache_factory::$data['settings--events']['develop']->on_form_validate['demo_default']->weight = 0;
  ...
  cache_factory::$data['settings--events']['user']->on_form_validate['user_delete_default'] = new \stdClass();
  cache_factory::$data['settings--events']['user']->on_form_validate['user_delete_default']->for = 'user_delete';
  cache_factory::$data['settings--events']['user']->on_form_validate['user_delete_default']->handler = '\\effectivecore\\events_form::on_validate';
  cache_factory::$data['settings--events']['user']->on_form_validate['user_delete_default']->weight = 0;
  cache_factory::$data['settings--events']['user']->on_form_validate['user_edit_default'] = new \stdClass();
  cache_factory::$data['settings--events']['user']->on_form_validate['user_edit_default']->for = 'user_edit';
  cache_factory::$data['settings--events']['user']->on_form_validate['user_edit_default']->handler = '\\effectivecore\\events_form::on_validate';
  cache_factory::$data['settings--events']['user']->on_form_validate['user_edit_default']->weight = 0;
