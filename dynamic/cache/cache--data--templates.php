...
namespace effcore { # cache for data--templates
  ...
  cache::$data['data--templates']['tree']['tab']->markup = '<x-tab %%_attributes> <ul>%%_children</ul> </x-tab>';
  ...
  cache::$data['data--templates']['tree']['tab_item_children'] = new \stdClass();
  cache::$data['data--templates']['tree']['tab_item_children']->type = 'inline';
  cache::$data['data--templates']['tree']['tab_item_children']->markup = '<ul> %%_children </ul>';
