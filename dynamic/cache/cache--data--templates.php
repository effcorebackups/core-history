...
namespace effectivecore { # cache for data--templates
  ...
  cache::$data['data--templates']['page']['page']->path = 'frontend/template--page.html';
  ...
  cache::$data['data--templates']['page']['page_access_denided']->path = 'frontend/template--page--access_denided.html';
  cache::$data['data--templates']['page']['page_not_found'] = new \stdClass();
  cache::$data['data--templates']['page']['page_not_found']->type = 'file';
  cache::$data['data--templates']['page']['page_not_found']->path = 'frontend/template--page--not_found.html';
  cache::$data['data--templates']['page']['page_simple'] = new \stdClass();
  cache::$data['data--templates']['page']['page_simple']->type = 'file';
  cache::$data['data--templates']['page']['page_simple']->path = 'frontend/template--page_simple.html';
  cache::$data['data--templates']['page']['canvas_svg'] = new \stdClass();
  cache::$data['data--templates']['page']['canvas_svg']->type = 'file';
  cache::$data['data--templates']['page']['canvas_svg']->path = 'frontend/template--canvas_svg.xml';
