...
namespace effcore { # cache for data--entities-user-relation_role_ws_user
  ...
  cache::$data['data--entities-user-relation_role_ws_user']->constraints['primary_id_role_id_user']->type = 'primary';
  ...
  cache::$data['data--entities-user-relation_role_ws_user']->constraints['foreign_id_user'] = new \stdClass();
  cache::$data['data--entities-user-relation_role_ws_user']->constraints['foreign_id_user']->type = 'foreign';
  cache::$data['data--entities-user-relation_role_ws_user']->constraints['foreign_id_user']->fields['id_user'] = 'id_user';
  cache::$data['data--entities-user-relation_role_ws_user']->constraints['foreign_id_user']->references = 'users';
  cache::$data['data--entities-user-relation_role_ws_user']->constraints['foreign_id_user']->references_fields['id'] = 'id';
