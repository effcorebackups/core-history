...
namespace effcore { # cache for data--forms-demo-demo
  ...
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switchers'] = new \effcore\group_switchers();
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switchers']->element_attributes['data-type'] = 'switcher';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switchers']->element_attributes['name'] = 'switchers[]';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switchers']->values['switcher_1'] = 'Switcher 1';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switchers']->values['switcher_2'] = 'Switcher 2 (checked)';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switchers']->values['switcher_3'] = 'Switcher 3 (disabled)';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switchers']->values['switcher_4'] = 'Switcher 4 (disabled + checked)';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switchers']->disabled['switcher_3'] = 'switcher_3';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switchers']->disabled['switcher_4'] = 'switcher_4';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switchers']->checked['switcher_2'] = 'switcher_2';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switchers']->checked['switcher_4'] = 'switcher_4';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switchers']->title = 'Switchers';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switchers']->description = new \effcore\text();
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switchers']->description->args['type'] = 'group_switchers';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switchers']->description->text = 'Group %%_type.';
