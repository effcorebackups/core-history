...
namespace effcore { # cache for data--forms-demo-demo
  ...
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switcher_disabled'] = new \effcore\field_switcher();
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switcher_disabled']->title = 'Switcher (disabled)';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switcher_disabled']->element_attributes['name'] = 'switcher_disabled';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switcher_disabled']->element_attributes['value'] = 'switcher_disabled';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switcher_disabled']->element_attributes['checked'] = 'checked';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switcher_disabled']->element_attributes['disabled'] = 'disabled';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switcher_disabled']->description = new \effcore\text();
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switcher_disabled']->description->args['type'] = 'field_switcher';
  cache::$data['data--forms-demo-demo']->children['form_elements']->children['checkboxes_all']->children['switcher_disabled']->description->text = 'Field %%_type.';
