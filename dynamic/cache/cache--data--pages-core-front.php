...
namespace effcore { # cache for data--pages-core-front
  ...
  cache::$data['data--pages-core-front']->content['block_logo']->handler = '\\effcore\\modules\\core\\events_page::on_show_block_logo';
  ...
  cache::$data['data--pages-core-front']->content['block_title']->handler = '\\effcore\\modules\\core\\events_page::on_show_block_title';
