...
namespace effcore { # cache for data--pages
  ...
  cache::$data['data--pages']['storage']['instance_update_by_entity_name_and_instance_id']->cache_name = 'data--pages-storage-instance_update_by_entity_name_and_instance_id';
  ...
  cache::$data['data--pages']['storage']['instance_delete_multiple_by_instances_id'] = new \effcore\external_cache();
  cache::$data['data--pages']['storage']['instance_delete_multiple_by_instances_id']->cache_name = 'data--pages-storage-instance_delete_multiple_by_instances_id';
  ...
  cache::$data['data--pages']['storage']['instance_delete_by_entity_name_and_instance_id'] = new \effcore\external_cache();
  cache::$data['data--pages']['storage']['instance_delete_by_entity_name_and_instance_id']->cache_name = 'data--pages-storage-instance_delete_by_entity_name_and_instance_id';
