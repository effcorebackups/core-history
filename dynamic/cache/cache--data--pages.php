...
namespace effectivecore { # cache for data--pages
  ...
  cache::$data['data--pages']['core']['front'] = new \effectivecore\different_cache();
  ...
  cache::$data['data--pages']['core']['install'] = new \effectivecore\different_cache();
  ...
  cache::$data['data--pages']['core']['modules'] = new \effectivecore\different_cache();
  ...
  cache::$data['data--pages']['develop']['demo'] = new \effectivecore\different_cache();
  ...
  cache::$data['data--pages']['page']['decoration'] = new \effectivecore\different_cache();
  ...
  cache::$data['data--pages']['user']['login'] = new \effectivecore\different_cache();
  ...
  cache::$data['data--pages']['user']['logout'] = new \effectivecore\different_cache();
  ...
  cache::$data['data--pages']['user']['registration'] = new \effectivecore\different_cache();
  ...
  cache::$data['data--pages']['user']['roles'] = new \effectivecore\different_cache();
  ...
  cache::$data['data--pages']['user']['user'] = new \effectivecore\different_cache();
  ...
  cache::$data['data--pages']['user']['user_delete'] = new \effectivecore\different_cache();
  ...
  cache::$data['data--pages']['user']['user_edit'] = new \effectivecore\different_cache();
  ...
  cache::$data['data--pages']['user']['users'] = new \effectivecore\different_cache();
