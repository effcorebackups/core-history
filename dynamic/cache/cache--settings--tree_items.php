...
namespace effectivecore { # cache for settings--tree_items
  ...
  cache::$data['settings--tree_items']['user']['login']->id_parent = 'user_anonymous';
  cache::$data['settings--tree_items']['user']['login']->parent_is_tree = true;
  ...
  cache::$data['settings--tree_items']['user']['login']->weight = -20;
  ...
  cache::$data['settings--tree_items']['user']['registration']->id_parent = 'user_anonymous';
  cache::$data['settings--tree_items']['user']['registration']->parent_is_tree = true;
  ...
  cache::$data['settings--tree_items']['user']['registration']->weight = -10;
  ...
  cache::$data['settings--tree_items']['user']['user_edit']->id_parent = 'user_logged_in';
  cache::$data['settings--tree_items']['user']['user_edit']->parent_is_tree = true;
  ...
  cache::$data['settings--tree_items']['user']['user_edit']->weight = -20;
  ...
  cache::$data['settings--tree_items']['user']['logout']->id_parent = 'user_logged_in';
  cache::$data['settings--tree_items']['user']['logout']->parent_is_tree = true;
  ...
  cache::$data['settings--tree_items']['user']['logout']->weight = -10;
