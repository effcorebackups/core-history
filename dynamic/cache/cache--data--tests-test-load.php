...
namespace effcore { # cache for data--tests-test-load
  ...
  cache::$data['data--tests-test-load']->scenario['repeat']->quantity = 50;
  cache::$data['data--tests-test-load']->scenario['repeat']->actions['request_page_front'] = new \effcore\step_request();
  cache::$data['data--tests-test-load']->scenario['repeat']->actions['request_page_front']->url = '/';
