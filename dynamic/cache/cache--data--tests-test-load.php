...
namespace effcore { # cache for data--tests-test-load
  ...
  cache::$data['data--tests-test-load']->scenario['response_check']->where = 'response';
  ...
  cache::$data['data--tests-test-load']->scenario['response_check']->on_success['response_check']->where = 'response';
