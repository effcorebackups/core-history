...
состоят из 3-15 строк кода.

Восприятие кода существенно облегчается благодаря "матричному" стилю вёрстки
(в некоторых местах напоминает синтаксис Python). Грамотное расположение файлов
в системе позволяет определить их назначение, не прибегая к документации.
...
При ручном копировании на веб-сервер файлов нового дистрибутива следует
убедиться, что новые пустые директории "dynamic" и "modules" из дистрибутива не
заменят старые на веб-сервер!
