...
- Злоумышленник может многократно послать предварительно заполненную
  форму (форму аутентификации "form_login", форму регистрации нового пользователя "form_registration",
  форму восстановления пароля "form_recovery") с целью перебора адресов электронной почты и/или
  имени пользователя и/или пароля или обхода CAPTCHA.
- Злоумышленник может ввести в поля формы данные для SQL-инъекции.
- Злоумышленник может подделать идентификатор сессии.
- Злоумышленник может разблокировать в форме заблокированные поля средствами браузера.
- Злоумышленник может послать большее значение поля чем разрешено атрибутами
