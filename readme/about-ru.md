...
и простых текстовых файлов типа "*.data" можно внедрить новый
функционал (например, как описанный выше) не прибегая к программированию.
Достаточно создать файлы типа "*.data", разместить их в новом модуле,
