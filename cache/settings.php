...
namespace effectivecore { # settings::$data[entity_type][scope]...
  ...
  settings::$data['module']['menu']->id = 'tree';
  settings::$data['module']['menu']->title = 'Tree';
  settings::$data['module']['menu']->description = 'Working with trees.';
  ...
  settings::$data['module']['menu']->on_init->handler = '\\effectivecore\\modules\\tree\\events_module::on_init';
  ...
  settings::$data['pages']['menu']['page_n']->styles['style_tree'] = new \stdClass();
  settings::$data['pages']['menu']['page_n']->styles['style_tree']->file = 'misc/tree.css';
  settings::$data['pages']['menu']['page_n']->content['tree_main'] = new \stdClass();
  settings::$data['pages']['menu']['page_n']->content['tree_main']->type = 'link';
  settings::$data['pages']['menu']['page_n']->content['tree_main']->entity = 'trees/core/main';
  settings::$data['pages']['menu']['page_n']->content['tree_main']->region = 'nav';
  ...
  settings::$data['templates']['menu']['tree'] = 'templates/template--tree.html';
  settings::$data['templates']['menu']['tree_self'] = 'templates/template--tree_self.html';
  settings::$data['templates']['menu']['tree_children'] = 'templates/template--tree_children.html';
  settings::$data['templates']['menu']['tree_item'] = 'templates/template--tree_item.html';
  settings::$data['templates']['menu']['tree_item_self'] = 'templates/template--tree_item_self.html';
  settings::$data['templates']['menu']['tree_item_children'] = 'templates/template--tree_item_children.html';
