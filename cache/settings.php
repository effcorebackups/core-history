...
namespace effectivecore { # settings::$data[entity_type][scope]...
  ...
  settings::$data['instances']['user']['user_1']->name = 'user';
  ...
  settings::$data['instances']['user']['user_2']->name = 'user';
  ...
  settings::$data['instances']['user']['role_anonymous']->name = 'role';
  ...
  settings::$data['instances']['user']['role_registered']->name = 'role';
  ...
  settings::$data['instances']['user']['role_admins']->name = 'role';
  ...
  settings::$data['instances']['user']['role_moderators']->name = 'role';
  ...
  settings::$data['instances']['user']['permission_user_profile_select']->name = 'permission';
  ...
  settings::$data['instances']['user']['permission_user_profile_update']->name = 'permission';
  ...
  settings::$data['instances']['user']['permission_user_profile_delete']->name = 'permission';
  ...
  settings::$data['instances']['user']['role_ws_user_admins_1']->name = 'role_ws_user';
  ...
  settings::$data['instances']['user']['role_ws_permission_admins_user_profile_select']->name = 'role_ws_permission';
  ...
  settings::$data['instances']['user']['role_ws_permission_admins_user_profile_update']->name = 'role_ws_permission';
  ...
  settings::$data['instances']['user']['role_ws_permission_admins_user_profile_insert']->name = 'role_ws_permission';
