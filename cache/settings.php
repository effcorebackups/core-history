...
namespace effectivecore { # settings::$data[type][scope]...
  ...
  settings::$data['module']['storage']->on_init = new \stdClass();
  settings::$data['module']['storage']->on_init->handler = '\\effectivecore\\modules\\storage\\events_module::on_init';
  settings::$data['module']['storage']->on_init->weight = -90;
