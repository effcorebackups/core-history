...
namespace effectivecore { # settings::$data[entity_type][scope]...
  ...
  settings::$data['instances']['user']['user']['user_root'] = new \stdClass();
  settings::$data['instances']['user']['user']['user_root']->id = 1;
  settings::$data['instances']['user']['user']['user_root']->password = 12345;
  settings::$data['instances']['user']['user']['user_root']->email = 'admin@example.com';
  settings::$data['instances']['user']['user']['user_root']->is_locked = 1;
  settings::$data['instances']['user']['user']['user_user'] = new \stdClass();
  settings::$data['instances']['user']['user']['user_user']->id = 2;
  settings::$data['instances']['user']['user']['user_user']->password = 12345;
  settings::$data['instances']['user']['user']['user_user']->email = 'user@example.com';
  settings::$data['instances']['user']['role']['role_anonymous'] = new \stdClass();
  settings::$data['instances']['user']['role']['role_anonymous']->id = 'anonymous';
  settings::$data['instances']['user']['role']['role_anonymous']->title = 'Anonymous';
  settings::$data['instances']['user']['role']['role_anonymous']->is_embed = 1;
  settings::$data['instances']['user']['role']['role_registered'] = new \stdClass();
  settings::$data['instances']['user']['role']['role_registered']->id = 'registered';
  settings::$data['instances']['user']['role']['role_registered']->title = 'Registered';
  settings::$data['instances']['user']['role']['role_registered']->is_embed = 1;
  settings::$data['instances']['user']['role']['role_admins'] = new \stdClass();
  settings::$data['instances']['user']['role']['role_admins']->id = 'admins';
  settings::$data['instances']['user']['role']['role_admins']->title = 'Administrators';
  settings::$data['instances']['user']['role']['role_admins']->is_embed = 1;
  settings::$data['instances']['user']['role']['role_moderators'] = new \stdClass();
  settings::$data['instances']['user']['role']['role_moderators']->id = 'moderators';
  settings::$data['instances']['user']['role']['role_moderators']->title = 'Moderators';
  settings::$data['instances']['user']['permission']['permission_user_profile_select'] = new \stdClass();
  settings::$data['instances']['user']['permission']['permission_user_profile_select']->id = 'user_profile_select';
  settings::$data['instances']['user']['permission']['permission_user_profile_select']->title = 'User profile: select';
  settings::$data['instances']['user']['permission']['permission_user_profile_update'] = new \stdClass();
  settings::$data['instances']['user']['permission']['permission_user_profile_update']->id = 'user_profile_update';
  settings::$data['instances']['user']['permission']['permission_user_profile_update']->title = 'User profile: update';
  settings::$data['instances']['user']['permission']['permission_user_profile_delete'] = new \stdClass();
  settings::$data['instances']['user']['permission']['permission_user_profile_delete']->id = 'user_profile_delete';
  settings::$data['instances']['user']['permission']['permission_user_profile_delete']->title = 'User profile: delete';
  settings::$data['instances']['user']['role_ws_user']['admin_ws_admin'] = new \stdClass();
  settings::$data['instances']['user']['role_ws_user']['admin_ws_admin']->user_id = 1;
  settings::$data['instances']['user']['role_ws_user']['admin_ws_admin']->role_id = 'admins';
  settings::$data['instances']['user']['role_ws_permission']['admins_ws_user_profile_select']['role_id'] = 'admins';
  settings::$data['instances']['user']['role_ws_permission']['admins_ws_user_profile_select']['permission_id'] = 'user_profile_select';
  settings::$data['instances']['user']['role_ws_permission']['admins_ws_user_profile_update']['role_id'] = 'admins';
  settings::$data['instances']['user']['role_ws_permission']['admins_ws_user_profile_update']['permission_id'] = 'user_profile_update';
  settings::$data['instances']['user']['role_ws_permission']['admins_ws_user_profile_insert']['role_id'] = 'admins';
  settings::$data['instances']['user']['role_ws_permission']['admins_ws_user_profile_insert']['permission_id'] = 'user_profile_insert';
